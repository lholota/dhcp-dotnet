...
namespace LH.Dhcp.UnitTests.Serialization
{
    ...
    public class DhcpBinaryValueReader_CtorShould
    {
        ...
        public void ThrowArgumentOutOfRangeException_GivenOffsetLowerThanZero()
        {
            var ex = Assert.Throws<ArgumentOutOfRangeException>(
                () => new DhcpBinaryValueReader(TestBytes, -1, 10));
        ...
        {
            var ex =Assert.Throws<ArgumentOutOfRangeException>(
                () => new DhcpBinaryValueReader(TestBytes, 10, 1000));
        ...
        public void ThrowArgumentNullException_GivenNullBytes()
        {
            var ex = Assert.Throws<ArgumentNullException>(
                () => new DhcpBinaryValueReader(null, 10, 2));
