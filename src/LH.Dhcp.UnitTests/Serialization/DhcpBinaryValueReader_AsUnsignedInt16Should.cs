...
namespace LH.Dhcp.UnitTests.Serialization
{
    ...
    public class DhcpBinaryValueReader_AsUnsignedInt16Should
    {
        ...
        {
            var valueReader = new DhcpBinaryValueReader(TestBytes, 0, 2);
        ...
        {
            var valueReader = new DhcpBinaryValueReader(TestBytes, 2, 2);
