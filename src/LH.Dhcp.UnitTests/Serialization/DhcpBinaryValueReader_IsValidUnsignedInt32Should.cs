...
namespace LH.Dhcp.UnitTests.Serialization
{
    ...
    public class DhcpBinaryValueReader_IsValidUnsignedInt32Should
    {
        [Theory]
        [InlineData(0)]
        [InlineData(1)]
        ...
        public void ReturnFalse_GivenInvalidLength(byte length)
        {
            ...
            Assert.False(valueReader.IsValidUnsignedInt32());
        }
        ...
        public void ReturnTrue_GivenValidLength()
        {
            ...
            Assert.True(valueReader.IsValidUnsignedInt32());
        }
    }
}