...
namespace LH.Dhcp.UnitTests.Serialization
{
    ...
    public class DhcpBinaryValueReader_AsByteShould
    {
        ...
        {
            var valueReader = new DhcpBinaryValueReader(TestBytes, 0, 1);
        ...
        {
            var valueReader = new DhcpBinaryValueReader(TestBytes, 2, 1);
