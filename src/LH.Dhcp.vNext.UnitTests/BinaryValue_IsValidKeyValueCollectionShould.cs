...
namespace LH.Dhcp.vNext.UnitTests
{
    ...
    public class BinaryValue_IsValidKeyValueCollectionShould
    {
        ...
        public void ReturnTrue_GivenBytesWithMultipleValues()
        {
            ...
            Assert.True(valueReader.IsValidKeyValueCollection());
        }
        ...
        public void ReturnFalse_GivenBytesWithDuplicateOption()
        {
            ...
            Assert.False(valueReader.IsValidKeyValueCollection());
        }
