namespace LH.Dhcp.vNext.UnitTests._DhcpPacketBuilder
{
    ...
    public class WithOption_KeyValueCollectionShould
    {
        ...
        //    {
        //        new AddOptionDelegate<IReadOnlyList<KeyValuePair<>>>((builder, optionCode, value) => builder.WithOption(optionCode, value))
        //    });
